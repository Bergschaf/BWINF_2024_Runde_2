...
\begin{document}
    ...
    \begin{korollar}
        ...
        \begin{enumerate}
            ...
            \item Wenn $T_1 = T_2$, dann haben $T_1$ und $T_2$ auf jeder Anzahl die gleiche Anzahl an internen Knoten
        \end{enumerate}
    \end{korollar}
    \begin{lemma}
    ...
    \end{lemma}
    \begin{proof}
        Folgt aus der Definition von $Expand_i$.
    \end{proof}
    \begin{korollar}
        Jeder vollständige Ebene-$i$-Baum kann durch $i$ Expand-Operationen vom Wurzel-Baum aus konstruiert werden.
    \end{korollar}
